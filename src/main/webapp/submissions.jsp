                ...
                <div class="container">
                    ...
                    <div class="card">
                            ...
                            <tbody>
                                <c:forEach var="s" items="${submissions}">
                                    <tr>
                                        ...
                                        <td>
                                            <fmt:formatDate value="${s.submittedAt}" pattern="yyyy-MM-dd HH:mm:ss" />
                                        </td>
                                        <td>
                                            ...
                                            <a href="assignments?action=preview&type=submissions&file=${s.filePath}"
                                                target="_blank" class="btn"
                                                style="width: auto; padding: 0.5rem 1rem; font-size: 0.8rem; background-color: #10b981; margin-left: 0.5rem;">
                                                Preview
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div style="margin-top: 2rem;">
                            <a href="assignments" style="color: var(--primary-color); text-decoration: none;">&larr;
                                Back to
                                Assignments</a>
                        </div>
                    </div>
